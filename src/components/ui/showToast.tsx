      ...
      >
        <div className="flex items-center p-4 space-x-4 w-full">
          ...
          <div className="flex-1">
            <p className="text-md font-semibold text-purple-900">{message}</p>
          </div>
          <div>
            <button
              onClick={() => toast.dismiss(t.id)}
              className="text-green-500 hover:text-purple-900 focus:outline-none transition-colors duration-200"
            >
              <svg
                className="h-5 w-5"
